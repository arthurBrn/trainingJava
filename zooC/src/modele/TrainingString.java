...
public class TrainingString {
	...
	public static void main(String args[ ])	{
		...
		//######Trouver un caractère spécific dans une chaine :
		String out;
		...
		out=output.nextLine();
			...
			boolean rechercherChaine(String word) {
				boolean result;
				//if(out.contains("I am")) { --> Vérifie si la chaine contient I am
				if(word.indexOf("I am") >0) { //--> vérifie si le retour de chaine I am dans la chaine out est > 0	
					result = true;
				}
				else {
					result = false;
